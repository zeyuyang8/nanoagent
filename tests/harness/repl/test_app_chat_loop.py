...
What it consumes: :class:`~nanoagent.harness.repl.app.InteractiveSession` and the
:class:`~nanoagent.harness.core.agent.Reply` / ``StopReason`` shapes — all imported read-only. No model
...
Run (from the repo root)::
    ...
    python3 -m pytest tests/harness/repl/test_app_chat_loop.py -x -q
"""
...
from nanoagent.harness.core.agent import Reply, StopReason
