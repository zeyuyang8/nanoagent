"""Offline pins for :func:`nanoagent.harness.run.build.select_tools` — the ``allowed_tools`` narrowing.
...
Run (from the repo root)::
    ...
    python3 -m pytest tests/harness/run/test_select_tools.py -q
"""
...
from nanoagent.harness.run.build import select_tools
