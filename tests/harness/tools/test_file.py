"""Offline unit tests for :mod:`nanoagent.harness.tools.file` and the workspace it resolves against.
...
* confinement — every path resolves under :func:`nanoagent.harness.core.workspace.current`, so a rollout given
...
Run (from the repo root)::
    ...
    python3 -m pytest tests/harness/tools/test_file.py -x -q
"""
...
from nanoagent.harness.tools.file import Edit, Read, Write
