...
:meth:`nanoagent.harness.core.model.Model.from_config` used to gate the name behind its own allowlist
...
seam that ``src/nanoagent/harness/configs/mgen.yaml`` documents failed before
...
Run (from the repo root)::
    ...
    python3 -m pytest tests/harness/core/test_model_backend_plugin.py -x -q
"""
