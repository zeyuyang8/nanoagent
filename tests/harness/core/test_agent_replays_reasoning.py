...
whatever :class:`~nanoagent.harness.core.agent.Agent` puts in the history is all the model gets back. Dropping
...
Run (from the repo root)::
    ...
    python3 -m pytest tests/harness/core/test_agent_replays_reasoning.py -x -q
"""
