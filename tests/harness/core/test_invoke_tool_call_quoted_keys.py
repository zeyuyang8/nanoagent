...
:func:`nanoagent.harness.core.agent._unquote_arg_keys` (applied in :func:`invoke_tool_call`) strips the
...
Run (from the repo root)::
    ...
    python3 -m pytest tests/harness/core/test_invoke_tool_call_quoted_keys.py -x -q
"""

from __future__ import annotations

from nanoagent.harness.core.agent import _unquote_arg_keys, invoke_tool_call, ToolCall
