"""Pin Agent.run's per-rollout TOKEN_LIMIT cap (:mod:`nanoagent.harness.core.agent`).
...
self._token_limit`` that emits a terminal :attr:`~nanoagent.harness.core.agent.StopReason.TOKEN_LIMIT`,
...
Run (from the repo root)::
    ...
    python3 -m pytest tests/harness/core/test_agent_token_limit.py -x -q
"""
