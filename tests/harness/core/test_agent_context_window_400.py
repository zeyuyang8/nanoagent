...
a graceful :class:`~nanoagent.harness.core.agent.StopReason.CONTEXT_WINDOW` (:mod:`nanoagent.harness.core.agent`).
...
:class:`~nanoagent.harness.core.agent.StopReason`, and one :class:`~nanoagent.harness.core.tool.Tool` subclass — all
...
Run (from the repo root)::
    ...
    python3 -m pytest tests/harness/core/test_agent_context_window_400.py -x -q
"""
