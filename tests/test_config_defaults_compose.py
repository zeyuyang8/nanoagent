...
(:func:`nanoagent.config._merge_specs`). This lets one self-contained config pull in a shared one
...
Run (from the repo root)::
    ...
    python3 -m pytest tests/test_config_defaults_compose.py -x -q
"""
...
import pytest
from nanoagent.config import load_config_args
