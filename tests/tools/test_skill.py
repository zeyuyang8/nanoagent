...
:func:`~nanoagent.run.build.build_prompt_and_tools` assembles from it (plus that function's
sibling :func:`~nanoagent.run.build.context_text`, which folds in the project's own instructions).
...
from nanoagent.run.build import build_prompt_and_tools, context_text
