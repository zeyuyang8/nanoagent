"""Offline unit test for ``nanoagent.repl.app.main`` — the ``chat`` subcommand entry point.

What it consumes: :func:`nanoagent.repl.app.main` (read-only), with its two collaborators
...
Run (from the repo root)::
    ...
    python3 -m pytest tests/repl/test_app_main.py -x -q
"""
