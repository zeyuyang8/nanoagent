"""Offline tests for :mod:`nanoagent.repl.tree` — the conversation as a tree of branches.
...
Run (from the repo root)::
    ...
    python3 -m pytest tests/repl/test_tree.py -x -q
"""
...
from nanoagent.repl import tree as tree_mod
