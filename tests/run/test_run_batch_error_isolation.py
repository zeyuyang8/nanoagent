"""Offline test: :func:`nanoagent.run.batch.run_batch` ISOLATES a failing task — one rollout that
...
single test drives :func:`~nanoagent.run.batch.run_batch` over a 3-task batch at ``concurrency=3`` (the
...
Run (from the repo root)::
    ...
    python3 -m pytest tests/run/test_run_batch_error_isolation.py -q
"""
