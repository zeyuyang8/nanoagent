"""Offline pins for :func:`nanoagent.run.build.select_tools` — the ``allowed_tools`` narrowing.
...
Run (from the repo root)::
    ...
    python3 -m pytest tests/run/test_select_tools.py -q
"""
...
from nanoagent.run.build import select_tools
