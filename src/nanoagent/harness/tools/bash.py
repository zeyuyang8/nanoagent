...
Its own module rather than a class in :mod:`nanoagent.harness.core.tool` because :func:`~nanoagent.harness.core.tool.get_tools`
...
Isolation gap: like :class:`~nanoagent.harness.tools.code.CodeExec` this is a local subprocess, NOT an
...
from nanoagent.harness.core.tool import communicate_or_kill, JsonSchema, Tool
