...
Its own module rather than a class in :mod:`nanoagent.core.tool` because :func:`~nanoagent.core.tool.get_tools`
...
from nanoagent.core.tool import communicate_or_kill, JsonSchema, Tool
